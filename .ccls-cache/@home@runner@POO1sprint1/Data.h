...
public:
    ...
    Data(Formato valFormato);       //Construtor default de formato de dataAgendamento especifico
    ...
    Data dateNow();     //Retorna a dataAgendamento do presente momento
    Data plusOneMonth();
    void printData();       //Imprime a dataAgendamento na tela de acordo com o formato ja atribuido
    string getData();       //Retorna a dataAgendamento no formato de string
