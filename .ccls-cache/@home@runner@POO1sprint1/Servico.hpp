...
public:
    ...
    Servico(const Data &dataAgendamento, const Data &dataCriacao, Funcionario funcionario, bool            statusServico, const Data &dataExecucao, Endereco endereco, UnidadeConsumidora 
            unidadeConsumidora);
