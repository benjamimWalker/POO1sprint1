...
Data Data::operator-(Data &d2)
{
    ...
    if (ticks<d2.getTicks())        //Tratamento de excecao se for tentada uma subtracao impossivel
        throw ExecaoCustomizada("Erro: Resultado eh dataAgendamento negativa, inverta parametros");
    else
        return aux;
}
...
Data Data::plusOneMonth() {
    Data d2 = *this;
    d2.setMes(d2.getMes() + 1);
    return d2;
}

Data Data::plusOneDay() {
    Data d2 = *this;
    d2.setDia(d2.getDia() + 1);
    return d2;
}

Data Data::plusOneYear() {
    Data d2 = *this;
    d2.setAno(d2.getAno() + 1);
    return d2;
}
